          ...
          return (
            <th
              ...
              className={cn(
                ...
                stickyHeader && 'sticky top-0 z-10 bg-navi-surface-hover dark:bg-navi-surface-hover'
              )}
            >
      ...
      {rows.map((row) => (
        <tr
          ...
          className={cn(
            ...
            onRowClick && 'cursor-pointer hover:bg-navi-surface-hover/70 dark:hover:bg-navi-surface-hover'
          )}
...
const DataTableInner = <TData,>(
  ...
  const handleExportCSV = React.useCallback(() => {
    ...
    const csv = [headers.map((value) => quotedCsvValue(value)).join(','), ...body].join('\n')
  ...
  return (
    ...
    >
      ...
      <div className={cn('w-full overflow-x-auto', stickyHeader && 'max-h-104 overflow-y-auto')}>
        <table
          role="table"
