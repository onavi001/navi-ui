    ...
    extend: {
      colors: {
        navi: {
          ...
          'primary-light': 'rgb(var(--navi-color-primary-light) / <alpha-value>)',
          'primary-dark': 'rgb(var(--navi-color-primary-dark) / <alpha-value>)',
          neutral: 'rgb(var(--navi-color-neutral) / <alpha-value>)',
          'neutral-light': 'rgb(var(--navi-color-neutral-light) / <alpha-value>)',
          'neutral-dark': 'rgb(var(--navi-color-neutral-dark) / <alpha-value>)',
          success: 'rgb(var(--navi-color-success) / <alpha-value>)',
          'success-light': 'rgb(var(--navi-color-success-light) / <alpha-value>)',
          warning: 'rgb(var(--navi-color-warning) / <alpha-value>)',
          'warning-light': 'rgb(var(--navi-color-warning-light) / <alpha-value>)',
          destructive: 'rgb(var(--navi-color-destructive) / <alpha-value>)',
          'destructive-dark': 'rgb(var(--navi-color-destructive-dark) / <alpha-value>)',
          'destructive-light': 'rgb(var(--navi-color-destructive-light) / <alpha-value>)',
          ...
          'surface-hover': 'rgb(var(--navi-color-surface-hover) / <alpha-value>)',
          'surface-active': 'rgb(var(--navi-color-surface-active) / <alpha-value>)',
          overlay: 'rgb(var(--navi-color-overlay) / <alpha-value>)',
          'overlay-light': 'rgb(var(--navi-color-overlay-light) / <alpha-value>)',
